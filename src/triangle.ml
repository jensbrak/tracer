(*****************************************************************************
 * FILE      : triangle.ml
 * CONTENTS  : Implementation of module Triangle.
 * AUTHOR(S) : Jens Olsson <jenso@csd.uu.se>
 * EDITED    : Time-stamp: <2000-01-05 16:06:56 jenso>
 * COMMENTS  : 
 *****************************************************************************)
open Option

(*****************************************************************************
 * DATATYPE  : [triangle] is the representation of ADT Triangle.
 * COMMENTS  : 
 *****************************************************************************)
type triangle = 
  {
...
(*****************************************************************************
 * FUNCTION  : [createPoint] is public, see interface (triangle.mli) for 
 *           : description.
...
let createPoint corner sideA sideB surface = 
  ...
  let rayIntersects ray =
    ...
    if vd = 0.0 then
      (* Ray parallel to plane of triangle, ie no hit *)
      NONE
    else
      (* Not parallel, check if intersecting triangle *)
	...
	(* See if ray intersects within triangle bounds *)
	let ri = 
...
(*****************************************************************************
 * FUNCTION  : [create] is public, see interface (triangle.mli) for 
 *           : description.
 * COMMENTS  :  
 *****************************************************************************)
...
(*****************************************************************************
 * FUNCTION  : [rayIntersects] is public, see interface (triangle.mli) for 
 *           : description.
...
(*****************************************************************************
 * FUNCTION  : [hitPoint] is public, see interface (triangle.mli) for 
 *           : description.
 * COMMENTS  : See 'createPoint' for implementation.
 *****************************************************************************)
